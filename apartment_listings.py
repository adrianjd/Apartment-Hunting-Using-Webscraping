...
def find_realtor_listings():
    ...
    with open('apartments.csv', 'w', encoding='utf8', newline='') as f:
        ...
        headers = ['Website', 'Price', 'Location', 'Beds', 'Baths', 'Size', 'Pets'] # Column headers for csv file
        ...
        for listing in listings:
            ...
            info = [website, price, location, bed, bath, area, pets]
            output_writer.writerow(realtor_info)
...
def find_redfin_listings():
    ...
    # Input each listing into a file
    with open('apartments.csv', 'a', encoding='utf8', newline='') as f:
        output_writer = csv.writer(f)
        ...
        for listing in listings:
            ...
            redfin_info = [website, price, location, bed, bath, area, pets]
            output_writer.writerow(redfin_info)
...
def find_zillow_listings():
    ...
    with open('apartments.csv', 'a', encoding='utf8', newline='') as f:
        ...
        for listing in listings:
            ...
            zillow_info = [website, price, location, bed, bath, area, pets]
            output_writer.writerow(zillow_info)

print(os.getcwd()) # Print this to find working directory for created csv file; comment out if not needed
find_realtor_listings()
find_redfin_listings()
find_zillow_listings()
